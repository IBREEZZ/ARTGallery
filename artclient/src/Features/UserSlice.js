...
export const login = createAsyncThunk("cd po/login", async (userData) => {
  try {
    const response = await axios.post("https://artgallery-server1.onrender.com/login", {
...
export const registerUser = createAsyncThunk(
  ...
  async (userData) => {
    try {
      ...
      const response = await axios.post("https://artgallery-server1.onrender.com/registerUser", {
        name: userData.name,
